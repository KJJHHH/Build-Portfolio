...
class summary():
    ...
    """
        ...
        "train_size": 5,    # y
        "test_size": 1,     # m
        "test_start": 2021,  # start test from 2021/01
        "n_trials": 1,      # NN 
        "not_short": False, # if not short == True: only do long
        "ls_decision": ["test", "no running"], # long short decision ["test"/"train", "running"]
    ...
    def __init__(self, 
        ...
        train_size
        test_size
        test_start: decide nacktest start date
    ...
    def initialise(test_start, train_size, test_size):
