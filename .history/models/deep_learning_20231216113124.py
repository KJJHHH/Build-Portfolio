...
class deep_learning():
    def __init__(self, industry, input_size = None):
    ...
    def dl_pipeline(self, 
        ...
        if tune == True:
            ...
            with open(f"nn_hyperparam/{self.industry}/nnconfig_{n_trials}trial.pickle", "rb") as f: 
                config_past = pickle.load(f)
        ...
        test_hat, train_hat, loss = self.tune_train(config, data)
