...
class Rolling_Prediction:
    ...
    def fit_model(self, train_X, train_y, ttest_X, test_y):
            # fit model
            if self.model == 'ols':
    ...
    def transform_decide_poly_kernel_predict(self, train_X, train_y, test_X, test_y):
        ###########################################
    ...
    def predicting(self):
        ...
        if sort_industry == True:
            ...
            for industry in self.train["Industry_Eng"].unique():
                ...
                predict = self.transform_decide_poly_kernel_predict(
                    train_X, train_y, 
