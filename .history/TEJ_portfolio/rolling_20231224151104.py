...
class Rolling_Prediction:
    ...
    def rolling_predict(self):
        ...
        while True:
            ...
            # backtest
            backtest_ret = self.backtest(predict_result_market, self.mode)   
            ...
            # update
            train, test, start_train_date, start_test_date = self.update_data(data_preprocess, start_train_date, train_size)
