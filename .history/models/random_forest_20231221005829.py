...
def random_forest(
    ...
    if tune == True:
        ...
        with open(
            f"C:/Users/USER/Desktop/portfolio/temp_params_tuned_per_6month/elastic_net/random_forest.pickle",
            "wb") as f:
            pickle.dump(tuned_model, f)
    else:
        with open(
            f"C:/Users/USER/Desktop/portfolio/tunedparams_tempper6month/random_forest.pickle",
            "rb") as f:
