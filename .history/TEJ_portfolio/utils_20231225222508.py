...
class feature_engineer:
    ...
    def transform_poly_selected_pearsonr(self, X, y):
        # 1. poly features
    ...
    def selected_bic(self, X, y):
        ...
        while True:
            ...
            for i in range(X.shape[1]):
                ...
                linear_reg = fit_linear(X[:, selected_col + [i]], y)
...
def build_wls(X, y, HC = "nonrobust"): 
    ...
    # fit WLS
    linear_reg_weighted = sm.WLS(y, X, weights = weights).fit(cov_type = "HC0")
