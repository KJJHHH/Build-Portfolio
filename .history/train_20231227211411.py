...
class summary():
    ...
    def train_lsdecision(self):        
        ...
        if self.model_name == "linear": # False: 
            test_hat, train_hat, test+loss = linear_regression(self.param, self.data, self.tune)
        elif self.model_name == "decision tree": # False: 
            test_hat, train_hat, loss = decision_tree(self.param, self.data, self.tune)
        elif self.model_name == "xgboost": # False: 
            test_hat, train_hat, loss = xgboost(self.param, self.data, self.tune)
        elif self.model_name == "random forest":
