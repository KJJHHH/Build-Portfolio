...
def plot_model_result(industry, model, model_config):
    ...
    2. Get trading detail inculde number of long and short, and trading rate (n to trade/alls stock)
    
    """
    performance_rolling, rplsw_rolling, market_rolling = models_get_result(industry, model, model_config)
