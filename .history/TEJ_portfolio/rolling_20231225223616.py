...
class Rolling_Prediction:
    def __init__(self, 
        ...
        X_poly_selected_corr = fe.transform_poly_selected_pearsonr(X_scale_winsor, y_train)
        X_pca = fe.transform_pca(X_poly_selected_corr, var = 100)
        X_selected_bic = fe.selected_bic(X_pca, y_train)
