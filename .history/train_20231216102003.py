...
class summary():
    ...
    def train_lsdecision(
        ...
        if model_strategy["model"] == "linear": # False: 
            test_hat, train_hat, loss = linear_regression()
        elif model_strategy["model"] == "decision tree": # False: 
            test_hat, train_hat, loss = decision_tree(self.param, fnl_df, tun)
        elif model_strategy["model"] == "xgboost": # False: 
            pred, y_train_hat, loss = xgboost(self.param, fnl_df, tun)
