...
print(market_rolling["return"].values)
plt.fill_between(market_rolling.index, 0, market_rolling["return"].values,
                where=(market_rolling["return"].values > 0), color='red', alpha=0.3, label='market > 0')
plt.legend()
plt.show()