...
class summary():
    ...
    def data_train(self, fnl_df, model_strategy, longshort_thres = None, 
                   tune = False, ensemble_addmodel = False):        
        ...
        longshort_strategy = y_train_hat 
        if longshort_thres == None:   # For first rolling prediction and ensemble do not use running mean
            longshort_thres = {}
        ...
        elif longshort_thres != None: # Running mean for the thresholds
