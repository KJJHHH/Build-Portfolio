...
🐱 Building stock portfolio by utilising different machine learning algorithm including linear regressions, SVM, tree methods, and deep learning and trainthe algorithms with rolling prediction for each month.. The portfolios are based on automotive, semi conductor, and TFT-LCD industry. 
