...
class Rolling_Prediction:
    ...
    def update_rolling_data(self, first_rolling = False):
        ...
        train = self.data_clean[(self.data_clean["mdate"] < end_train_date) & \
                                (self.data_clean["mdate"] >= self.start_train_date)]
        test = self.data_clean[(self.data_clean["mdate"] < end_test_date) & \
    ...
    def rolling_predict(self):
        ...
        while True:
            print("="*80)
            print(f"Test: {} with size {self.test.shape}")
