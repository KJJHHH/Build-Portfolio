...
# ------------------------
from model import Data, Net, Data_tune, Net_tune, Net_tuned
...
class summary():
    ...
    def data_train(self, fnl_df, model_strategy, param, longshort_thres = None):        
        ...
        if model_strategy["model"] == "linear": # False: 
            ...
            y_hat, y_train_hat, test_loss = tune_train(config, data)
            print(y_hat)
            #######################################
            #######################################
            # No tune
        ...
        return data_tp, longshort_thres, loss # test_losss
