...
class summary():
    def __init__(self, param, input_size = None):
        ...
        ######################################################
        """
        Build the pipeline of data and train in SINGLE period,
        which include:
        1. get the train and test period of date, for initialise or update
        2. XySplit data into X_train, y_train, X_test, y_test
        3. train_lsdecision:
        """
