...
class Rolling_Prediction:
    def __init__(self, 
        ...
        self.trans = transform_preprocess(scale_method = 'MinMax', winsor = True)`
        - `X_train, X_test = trans.transform(X_train, X_test)`
    ...
    def decide_industry_predicting(self, train, test, mode):
