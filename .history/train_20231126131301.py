...
class summary():
    ...
    def data_train(self, fnl_df, model_strategy, param, longshort_thres = None, ensemble_crosstime = False):        
        ...
        if model_strategy["model"] == "ensemble" and ensemble_progress == True:
