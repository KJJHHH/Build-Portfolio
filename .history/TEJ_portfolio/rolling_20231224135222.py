...
class Rolling_Prediction:
    def __init__(self, 
        ...
        self.train, self.test, self.start_train_date, self.start_test_date = \
            self.update_data(data_week_return, self.start_train_date, mode['train_size'])
        self.transform_method = transform_method
        

    def update_data(self, data_week_return, start_train_date, train_size = 6):
    ...
    def rolling_predict(self, data_preprocess, mode):
        # max date
